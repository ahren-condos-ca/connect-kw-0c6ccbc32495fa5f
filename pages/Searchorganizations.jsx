...
export default function Searchorganizations() {
  return (
    <div className="bg-[var(--color-background)] text-[var(--color-text)] min-h-screen">
      ...
      <Table aria-label="Organizations results">
      <TableHeader>
      ...
      <TableBody>
      <TableRow key="1"><TableCell>KW Chamber</TableCell><TableCell>Association</TableCell><TableCell>Kitchener</TableCell></TableRow>
      <TableRow key="2"><TableCell>UWaterloo</TableCell><TableCell>University</TableCell><TableCell>Waterloo</TableCell></TableRow>
      <TableRow key="3"><TableCell>Communitech</TableCell><TableCell>Hub</TableCell><TableCell>Kitchener</TableCell></TableRow>
      </TableBody>
      </Table>
      </CardBody>
      </Card>
