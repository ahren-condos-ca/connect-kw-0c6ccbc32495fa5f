...
export default function Persondetail() {
  ...
  return (
   <div className="bg-[var(--color-background)] text-[var(--color-text)] min-h-screen">
      ...
      <h1 className="text-2xl font-bold">Person Profile</h1>
      <Card className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl">
      <CardHeader className="px-6 pt-6 pb-0">
      <h2 className="text-xl font-semibold">Person ID: {id}</h2>
      </CardHeader>
      <CardBody className="p-6 pt-4 text-[var(--color-text)]/80">
      This is a scaffolded person detail page. Add bio, roles, affiliations, and connections here.
      </CardBody>
      </Card>
      </div>
      </div>
